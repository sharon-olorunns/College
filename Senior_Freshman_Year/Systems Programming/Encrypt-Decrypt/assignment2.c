...
int main( int argc, char *argv[] )
{
    ...
    char *haystack = "encryption";
    char *haystackA = "decryption";
    char *needle = argv[1];
    char *encrypt = strcasestr(haystack,needle);
    char *decrypt = strcasestr(haystackA,needle);
